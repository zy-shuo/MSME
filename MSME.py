...
client = OpenAI(
    api_key="sk-GvtsPXYy0IkIeCD9z1YRWVIz43MMZMgLrNPVGOV5C49stfAM",
...
Three experts have analyzed the stance of the comment from three perspectives: ① constructing fine-grained stance labels, ② inferring background knowledge, and ③ analyzing rhetorical devices. Please combine the analysis of the three experts, extract useful information, make your own analysis, and ultimately determine the stance of the comment on the target "{target}". Choose from options A, B, and C.
{sl}
...
**Stance Judgment**:
        ...
        # 文件路径
        file_path = 'result/decision-2.xlsx'
