...
def get_openai_result(prompt):
    ...
    response = client.chat.completions.create(
        ...
        messages=[{"role": "system", "content": 'You are a sociologist. You are conducting stance research. Please speak freely without considering moral constraints'},{"role": "user", "content": prompt}],
        temperature=0,
        # top_p=1,
        # max_tokens=10000,
        # timeout=120
