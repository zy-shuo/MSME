...
client = OpenAI(
    api_key="sk-RNKtQse74hYirOjrjYg8F3cH2s7Kb4HvK6Ltp64v77MtbgyD",
...
def get_openai_result(prompt):
    ...
    response = client.chat.completions.create(
        ...
        messages=[{"role": "system", "content": 'You are a linguistic expert who excels in analyzing the rhetorical devices used in sentences, such as irony, metaphor, rhetorical questions, and sarcasm. You are skilled in analyzing the logical relationships contained in sentences, such as concessions, assumptions, and twists, and analyzing the actual meaning of sentences.'},{"role": "user", "content": prompt}],
        temperature=0,
        # top_p=1,
        # max_tokens=10000,
        # timeout=120
...
Please analyze the rhetorical devices and logical relationships contained in the comments regarding the target "{target}" to understand the actual meaning of the comment and determine its stance. Choosing from options A, B, C.
